...
const docTemplate = `{
    ...
    "paths": {
        "/authors": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Author qo‘shish modeli",
                        "name": "author",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/books": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Book qo‘shish modeli",
                        "name": "book",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/categories": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Category qo‘shish modeli",
                        "name": "category",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        "main.Author": {
            ...
            "properties": {
                "books": {
                    "description": "1 author → ko‘p book",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.Book"
                    }
        ...
        "main.Category": {
            ...
            "properties": {
                "books": {
                    "description": "1 category → ko‘p book",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.Book"
                    }
